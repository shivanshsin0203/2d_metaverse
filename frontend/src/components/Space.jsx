    ...
    <div className="flex flex-col w-screen h-screen ">
          ...
          {chat ? (
            <div className="flex flex-col h-full">
              <div className=" w-[95%] justify-between items-center flex">
                <span className=" p-3 text-xl text-gray-400 font-bold">
                  Chat
                </span>
                <span
                  onClick={() => {
            ...
            <div>
              <div className=" w-[95%] justify-start items-center flex">
                ...
                <span
                  ...
                  className=" text-lg text-gray-300 cursor-pointer ml-[57%]"
                >
                  X
                </span>
              </div>
      ...
      <div className=" w-screen h-[6%] bg-[#202540] flex items-center">
        ...
        <div className=" ml-[3%] h-[80%] flex  bg-[#2D335A] space-x-2 rounded-lg items-center justify-center  ">
          <video muted ref={yourStream} className=" w-14 h-8 "></video>
          ...
          {audio ? (
            <Mic
              size={20}
              className="text-gray-300 m-2 cursor-pointer"
              onClick={() => {
                setAudio(false);
              }}
            />
            ...
            <MicOff
              size={20}
              className=" bg-red-500 text-gray-300 m-2 cursor-pointer"
              onClick={() => {
                setAudio(true);
              }}
            />
          ...
          {video ? (
            <Video
              size={20}
              className="text-gray-300 m-2 cursor-pointer mr-2"
              onClick={() => {
                setVideo(false);
              }}
            />
            ...
            <VideoOff
              size={20}
              className="mr-2 bg-red-500 text-gray-300 m-2 cursor-pointer"
              onClick={() => {
                setVideo(true);
              }}
            />
        ...
        <MessageCircle
          ...
          size={20}
          className="text-gray-300 m-2 cursor-pointer ml-[65%]"
        />
        ...
        <DoorOpen
          size={23}
          className="text-gray-300 m-2 cursor-pointer ml-9"
          onClick={() => {
            navigate("/space");
          }}
        />
